        ...
        <tet.section
            ...
            <div className="container relative z-10 h-[800px]">
                <div className="h-full content relative flex gap-6 items-end">
                    ...
                    <div className="h-[100px] bg-red-300 flex-shrink-0 basis-0 flex-grow"></div>
                    <div className="h-[200px] bg-red-300 flex-shrink-0 basis-0 flex-grow"></div>
                    <div className="h-[300px] bg-red-300 flex-shrink-0 basis-0 flex-grow"></div>
                    <div className="h-[400px] bg-red-300 flex-shrink-0 basis-0 flex-grow"></div>
                </div>
            </div>
        </tet.section>
    )
