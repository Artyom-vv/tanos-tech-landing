    ...
    return (
        <tet.div
            ...
            className="
                ...
                max-xl:bg-[linear-gradient(to_right,#CFD6DD_0px,#CFD6DD_8px,transparent_8px,transparent_24px)]
                xl:bg-[length:1px_24px]
                max-xl:bg-[length:24px_1px]
                xl:bg-repeat-y
                max-xl:bg-repeat-x
                xl:w-[1px]
                xl:h-auto
    ...
    return (
        <>
            <tet.div
                ...
                className="z-[5] absolute top-0 left-0 xl:h-1/2 xl:w-full max-xl:h-full max-xl:w-1/2"></tet.div>
            <tet.div
                ...
                className="z-[5] absolute xl:top-1/2 xl:left-0 max-xl:top-0 max-xl:right-0 xl:h-1/2 xl:w-full max-xl:h-full max-xl:w-1/2"></tet.div>
        </>
    )
}
...
export function TimeAndMaterials() {
    ...
    return (
        <tet.section
            ...
            <div
                className="max-xl:hidden container xl:px-10 dividers absolute top-0 left-1/2 -translate-x-1/2 w-full h-full flex xl:flex-row lg:flex-col justify-between z-1">
                <DashedBorderBox/>
                <DashedBorderBox/>
                <DashedBorderBox/>
                <DashedBorderBox/>
            ...
            <div className="max-xl:container relative z-10 xl:h-[688px] lg:h-[736px]">
                <div className="h-full content relative flex xl:flex-row max-xl:flex-col xl:gap-6 max-xl:gap-8 xl:items-end">
                    ...
                    <Step className="max-xl:mr-[108px] max-md:mr-[48px]" height="172px" step={1}>Исследуем отраслевые особенности и требования</Step>
                    <Step className="max-xl:mr-[72px] max-md:mr-[32px]" selected additionalInfo="На MVP проекта закладывается фиксированная сумма" height="344px"
                          step={2}>Разрабатываем и запускаем MVP проекта</Step>
                    <Step className="max-xl:mr-[36px] max-md:mr-[16px]" height="516px" step={3}>Привлекаем грантовое финансирование</Step>
